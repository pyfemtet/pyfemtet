...
class FemtetControl(AbstractPage):
    ...
    """
        ...
        Attributes:
            ...
            dummy (html.Div):
            connect_femtet_button (dbc.Button): call connect_femtet() callback.
            connect_femtet_button_spinner (dbc.Spinner): during connect_femtet() running, show spinner.
            femtet_state (html.Data):
