...
Even when importing models created in an external CAD (Solidworks) into Femtet for analysis with pyfemtet, it is possible to optimize by integrating CAD and Femtet.
